...
import '@/styles/index/homePage4.css';

import $ from 'jquery';
import React from 'react';
import {ajax} from '@/components/lib/util/ajax';
// import '@/components/lib/util/jquery-ui.min';
import Workload from '@/components/lib/sharing/workload/Workload';
...
import SpotCardExchangeModalContainer from '@/components/page/admin/page/components/SpotCardExchangeModal';
import rechargeModalContainer from '@/components/page/admin/page/components/RechargeModal';
import detailedModalContainer from '@/components/page/admin/page/components/DetailedModal';
import myRecommendationModalContainer from '@/components/page/admin/page/components/MyRecommendationModal';
